...
const defaultProps: Card01Props = {
    ...
    content: {
        text: "Just launched Wacky UI! Check out the documentation and let me know what you think 🎨",
        link: {
            title: "Wacky UI Documentation",
            description: "A comprehensive guide to Wacky UI",
